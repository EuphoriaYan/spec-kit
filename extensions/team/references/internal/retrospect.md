...
lesson promotion belongs to a later human-approved role skill.
...
| skill missing | role skill lacked a step or decision point | skill update |
...
2. Reconstruct the expected flow:
   ...
   - work context from `.specify/<category>/<work_id>/`;
   - code graph impact;
   - evidence;
   - human decision.
