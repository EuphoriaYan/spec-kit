...
- `work_id=<work-slug>` or `work_ids=<comma-separated-work-slugs>`
- `work_id=<bug-slug>` for bugfix lessons
...
`.specify/extensions/team/scripts/memory_adapter.py`. The local file adapter
...
```text
python .specify/extensions/team/scripts/memory_adapter.py --ensure-ignore
```
