...
|---|---|---|
| create or refine confidential feature intent | enhancement-internal | `speckit.team.specify` |
| create sanitized handoff requirement | enhancement-internal | `speckit.team.specify` |
