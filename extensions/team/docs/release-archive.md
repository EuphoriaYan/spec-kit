...
The release archive step is the release-scoped batch form of a later
human-approved memory capability. It turns completed work into a smaller
...
The memory capability creates private records first and promotes a smaller
reviewed subset to enterprise docs:
...
| Command | Scope |
|---|---|
| `speckit.team.plan-and-task` | one active work item |
| later review capability | one failed PR/check/incident/repeated AI mistake |
| later support-layer audit capability | support-layer audit across skills, knowledge, memory |
| later memory capability | one work item, bugfix, incident, release, or manual lesson |
| later release archive capability | one release or release candidate |
...
```text
Create a release knowledge archive for release_id=v1.4.0 since_tag=v1.3.0
privacy=public-safe.
